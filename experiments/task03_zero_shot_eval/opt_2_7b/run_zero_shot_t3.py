"""Task 03 zero-shot eval driver for OPT-2.7B.

Identical to the OPT-1.3B driver (model-agnostic via --model_path); kept as a
per-model copy so each model's run command points at a stable script path.
