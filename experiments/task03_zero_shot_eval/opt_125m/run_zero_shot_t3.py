"""Task 03 zero-shot eval driver — OPT-125M (identical to opt_1_3b version).

Kept as a per-model copy so each model's run is fully self-contained for the
thesis chapter. The body is identical to
experiments/task03_zero_shot_eval/opt_1_3b/run_zero_shot_t3.py.
"""
import argparse
import json
import os
