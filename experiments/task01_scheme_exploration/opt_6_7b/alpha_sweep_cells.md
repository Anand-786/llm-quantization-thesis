# Task 01: Alpha Sweep — O1 vs C on OPT-6.7B
...
SCALES = "/content/llm-quantization-thesis/smoothquant_repo/act_scales/opt-6.7b.pt"
...
for alpha in ALPHAS:
    for config_label, qparams in CONFIGS.items():
        ...
        fname = f"opt-6.7b_{config_label}_a{alpha}.json"
...
with open(os.path.join(SAVE_DIR, "all_results_opt-6.7b.json"), "w") as f:
    json.dump(all_results, f, indent=2)

# --- Print summary table ---
print(f"\n\n{'='*60}")
print(f"  ALPHA SWEEP RESULTS — OPT-6.7B")
print(f"{'='*60}")
